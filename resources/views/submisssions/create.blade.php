...
@section('content')
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between mb-2">
                    <h2 class="text-2xl font-bold text-gray-900">Dépôt de dossier d'admission</h2>
                    <span class="text-sm font-medium text-accent">Étape 1 sur 2</span>
                </div>
                ...
                <form action="{{ route('submission.store') }}" method="POST" enctype="multipart/form-data" id="submission-form">
                    ...
                    <div class="form-section">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                <label for="program" class="block text-sm font-medium text-gray-700 mb-1">Programme souhaité <span class="text-red-500">*</span></label>
                    ...
                    <div class="form-section">
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-accent hover:text-accent-dark focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            ...
                                            <input id="bac_attestation" name="bac_attestation" type="file" class="sr-only" accept=".pdf" required>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                        ...
                        <div class="space-y-3 mb-6">
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-accent hover:text-accent-dark focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            ...
                                            <input id="reports" name="reports[]" type="file" class="sr-only" accept=".pdf,.jpeg,.jpg,.png" multiple required>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                            ...
                            <div id="reports-preview" class="hidden mt-2 grid grid-cols-1 md:grid-cols-2 gap-3"></div>
                        </div>
                    ...
                    <div class="form-section bg-gray-50 px-6 py-4">
                        <div class="flex justify-end space-x-3">
                            ...
                            <button type="submit" id="submit-button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-accent hover:bg-accent-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent transition duration-150 ease-in-out">
    ...
    <script>
        class FileUploadManager {
            ...
            setupFileInputs() {
                const inputs = [
                    { id: 'photo', isImage: true, multiple: false },
                    { id: 'bac_attestation', isImage: false, multiple: false },
                    { id: 'motivation_letter', isImage: false, multiple: false },
                    { id: 'reports', isImage: false, multiple: true },
                    { id: 'additional_docs', isImage: false, multiple: true }
                ];
        ...
        class FormSubmissionHandler {
            constructor() {
                this.form = document.getElementById('submission-form');
            ...
            // Vérifiez que le token CSRF est bien présent
            // const csrfToken = document.querySelector('meta[name="csrf-token"]');
            // if (!csrfToken) {
            //     console.error('Meta CSRF token not found!');
            //     // Ajoutez-le dynamiquement si nécessaire
            ...
            async handleSubmit() {
                ...
                try {
                    ...
                    setTimeout(() => {
                        window.location.href = `/submissions/success/${data.submission_id}`;
                    }, 1500);
