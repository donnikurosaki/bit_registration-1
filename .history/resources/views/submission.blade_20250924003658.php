        ...
        <div class="max-w-5xl mx-auto">
                    ...
                    <div class="year-card active form-card bg-white p-6" data-year="first">
                        <div class="flex items-center mb-4">
                            <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mr-4">
                                <svg class="w-6 h-6 l" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div id="progress-bar-container" class="mb-8 hidden">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="text-sm font-medium text-blue-600" id="step-indicator">Étape 1 sur 2</span>
                </div>
                <div class="w-full bg-gray-200 rounded-full h-2.5">
                    <div class="bg-blue-600 h-2.5 rounded-full" id="progress-fill" style="width: 50%"></div>
                </div>
            </div>

            <!-- Premium Form Card for First Year -->
            <div id="first-year-form" class="form-card bg-white hidden">
                <form action="{{ route('submission.store') }}" method="POST" enctype="multipart/form-data" id="submission-form-first" class="submission-form">
                    @csrf
                    ...
                    <div class="form-section">
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            ...
                                            <input id="bac_attestation_first" name="bac_attestation" type="file" class="sr-only" accept=".pdf,.jpg,.jpeg,.png" required>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="file-drop-zone mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-blue-400 transition-all duration-300 cursor-pointer relative"
                                 data-input="motivation_letter_first">
                                <div class="space-y-1 text-center">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            <span>Télécharger le document</span>
                                            <input id="motivation_letter_first" name="motivation_letter" type="file" class="sr-only" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" required>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                            ...
                            <div id="motivation_letter_first-preview" class="hidden mt-2"></div>
                        </div>

                        <!-- Reports (Multiple) -->
                        <div class="space-y-3 mb-6">
                            <label class="block text-sm font-medium text-gray-700">
                                Bulletins (3ème trimestre) <span class="text-red-500">*</span>
                            </label>
                            <div class="file-drop-zone mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-blue-400 transition-all duration-300 cursor-pointer relative"
                                 data-input="reports_first">
                                <div class="space-y-1 text-center">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            ...
                                            <input id="reports_first" name="reports[]" type="file" class="sr-only" accept=".pdf,.jpeg,.jpg,.png" multiple required>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                                    <p class="text-xs text-gray-500">PDF, JPG, PNG (max 5MB chacun)</p>
                                </div>
                            </div>
                            <div id="reports_first-preview" class="hidden mt-2 grid grid-cols-1 md:grid-cols-2 gap-3"></div>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="file-drop-zone mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-blue-400 transition-all duration-300 cursor-pointer relative"
                                data-input="additional_docs_first">
                                <div class="space-y-1 text-center">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            <span>Télécharger les fichiers</span>
                                            <input id="additional_docs_first" name="additional_docs[]" type="file" class="sr-only" accept=".pdf,.doc,.docx,.jpeg,.jpg,.png" multiple>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                            ...
                            <div id="additional_docs_first-preview" class="hidden mt-2 grid grid-cols-1 md:grid-cols-2 gap-3"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-section bg-gray-50 px-6 py-4">
                        <div class="flex justify-between items-center">
                            ...
                            <button type="submit" class="submit-button inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out">
            ...
            <div id="second-year-form" class="form-card bg-white hidden">
                <form action="{{ route('submission.store') }}" method="POST" enctype="multipart/form-data" id="submission-form-second" class="submission-form">
                    @csrf
                    ...
                    <div class="form-section">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <!-- Email -->
                            <div>
                                <label for="email_second" class="block text-sm font-medium text-gray-700 mb-1">
                                    Email <span class="text-red-500">*</span>
                                </label>
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    ...
                                    <input type="email" name="email" id="email_second" required
                                           class="form-input-enhanced focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-3"
                                           placeholder="email@exemple.com" value="{{ $userData['email'] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <!-- Phone -->
                            <div>
                                <label for="phone_second" class="block text-sm font-medium text-gray-700 mb-1">
                                    Téléphone <span class="text-red-500">*</span>
                                </label>
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    ...
                                    <input type="tel" name="phone" id="phone_second" required
                                           class="form-input-enhanced focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-3"
                                           placeholder="Votre numéro de téléphone" value="{{ $userData['phone'] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <!-- Program Selection -->
                            <div class="sm:col-span-2">
                                <label for="program_second" class="block text-sm font-medium text-gray-700 mb-1">Programme souhaité <span class="text-red-500">*</span></label>
                                <select id="program_second" name="program" required
                                        class="form-input-enhanced mt-1 block w-full pl-3 pr-10 py-3 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                    <option value="">Sélectionnez un programme</option>
                                    @foreach($programs as $value => $label)
                                        <option value="{{ $value }}" @if(old('program') == $value) selected @endif>
                            ...
                            <!-- Specific fields for second year -->
                            <div class="sm:col-span-2">
                    ...
                    <div class="form-section">
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="file-drop-zone mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-blue-400 transition-all duration-300 cursor-pointer relative"
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            <span>Télécharger une photo</span>
                                            <input id="photo_second" name="photo" type="file" class="sr-only" accept="image/*" required>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                                    <p class="text-xs text-gray-500">PNG, JPG (max 2MB)</p>
                            ...
                            <div id="photo_second-preview" class="hidden mt-2"></div>
                        </div>

                        <!-- Previous Year Transcripts -->
                        <div class="space-y-3 mb-6">
                            <label class="block text-sm font-medium text-gray-700">
                                Relevés de notes de l'année précédente <span class="text-red-500">*</span>
                            </label>
                            <div class="file-drop-zone mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-blue-400 transition-all duration-300 cursor-pointer relative"
                                 data-input="transcripts_second">
                                <div class="space-y-1 text-center">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            <span>Télécharger les relevés</span>
                                            <input id="transcripts_second" name="transcripts[]" type="file" class="sr-only" accept=".pdf,.jpg,.jpeg,.png" multiple required>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                                    <p class="text-xs text-gray-500">PDF, JPG, PNG (max 5MB chacun)</p>
                            ...
                            <div id="transcripts_second-preview" class="hidden mt-2 grid grid-cols-1 md:grid-cols-2 gap-3"></div>
                        </div>
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="file-drop-zone mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-blue-400 transition-all duration-300 cursor-pointer relative"
                                 data-input="motivation_letter_second">
                                <div class="space-y-1 text-center">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            <span>Télécharger le document</span>
                                            <input id="motivation_letter_second" name="motivation_letter" type="file" class="sr-only" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" required>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                                    <p class="text-xs text-gray-500">PDF, DOC, DOCX, JPG, PNG (max 5MB)</p>
                            ...
                            <div id="motivation_letter_second-preview" class="hidden mt-2"></div>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="file-drop-zone mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-blue-400 transition-all duration-300 cursor-pointer relative"
                                data-input="additional_docs_second">
                                <div class="space-y-1 text-center">
                                    <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m4-6H8" />
                                    </svg>
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            <span>Télécharger les fichiers</span>
                                            <input id="additional_docs_second" name="additional_docs[]" type="file" class="sr-only" accept=".pdf,.doc,.docx,.jpeg,.jpg,.png" multiple>
                                        </label>
                                        <p class="pl-1">ou glisser-déposer</p>
                                    </div>
                                    <p class="text-xs text-gray-500">PDF, DOC, DOCX, JPG, PNG (max 5MB chacun)</p>
                            ...
                            <div id="additional_docs_second-preview" class="hidden mt-2 grid grid-cols-1 md:grid-cols-2 gap-3"></div>
                        </div>
                    </div>
    ...
    <script>
        ...
        class FileUploadManager {
            ...
            handleFileSelection(input) {
                ...
                if (files.length > 0) {
                    // Clear existing previews for single file inputs
                    if (!input.multiple) {
                        previewContainer.innerHTML = '';
                    }

                    files.forEach((file, index) => {
                        this.createFilePreview(file, previewContainer, input, index);
                    });
            ...
            createFilePreview(file, container, input, fileIndex) {
                const fileSize = (file.size / 1024 / 1024).toFixed(2);
                const fileId = `file-${input.id}-${Date.now()}-${fileIndex}`;
                ...
                deleteBtn.addEventListener('click', (e) => {
                    e.stopPropagation();
                    this.removeFile(input, fileIndex);
                    fileElement.remove();
            ...
            removeFile(input, fileIndex) {
                if (input.multiple) {
                    // Remove specific file from multiple file input
                    const files = Array.from(input.files);
        ...
        class FormSubmissionHandler {
            constructor(year) {
                this.year = year;
                this.form = document.getElementById(`submission-form-${year}`);
                this.submitBtn = this.form ? this.form.querySelector('.submit-button') : null;
                this.init();
            }
            ...
            async handleSubmit() {
                ...
                try {
                    ...
                    this.showSuccessMessage('Dossier soumis avec succès !');
            ...
            validateRequiredFiles() {
                const requiredInputs = this.form.querySelectorAll('input[type="file"][required]');
            ...
            showMessage(message, type) {
                ...
                messageDiv.className = `form-message fixed top-4 right-4 px-6 py-3 rounded-lg shadow-lg z-50 flex items-center animate-fade-in-up ${
                ...
                messageDiv.innerHTML = `
                    ${type === 'success' ?
                        ...
                        '<svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>'
                    }
                    ${message}
                `;
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.addEventListener('submit', (e) => {
                if (e.target.classList.contains('submission-form')) {
